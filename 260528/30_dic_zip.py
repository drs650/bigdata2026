...
print(result_zip) # <zip object at 0x000001B68BF29080>
...
def func2(name, *args):
    ...
    for i in args:
        total += i
    print(f'{name}이(가) 더한값은 {total}입니다.')

func2('푸바오', 1,2,3) # 푸바오이(가) 더한값은 6입니다.
func2('춘식이', 10, 20) # 춘식이이(가) 더한값은 30입니다.